        ...
        <#if formFields?has_content>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <select id="${fieldInfo.proName}Add" name="${fieldInfo.proName}" th:with="type=${"$"}{@dict.getType('${fieldInfo.proName}')}" class="form-control m-b"<#if fieldInfo.isNotNull> required</#if>>
...
<#if hasMultiLineType??>
                ...
                $('#${multiLineField}Add').val(content);
</#if>
